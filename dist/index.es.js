import React, { createContext, useContext, useRef, useEffect, useReducer, useState, useMemo } from 'react';
...
var VRow = function (props) {
    var _a = useContext(ScrollContext), dispatch = _a.dispatch, rowHeight = _a.rowHeight, totalLen = _a.totalLen;
    var children = props.children, restProps = __rest(props, ["children"]);
...
var VWrapper = function (props) {
    ...
    return (React.createElement("tbody", __assign({}, restProps, { style: { transform: "translateY(-" + offsetStart + "px)" } }), tempNode));
};
var VTable = function (props) {
    ...
    return (React.createElement("div", { ref: wrapTableRef, style: {
            width: '100%',
            position: 'relative',
            height: tableHeight,
            boxSizing: 'border-box',
        ...
        React.createElement(ScrollContext.Provider, { value: {
            ...
            React.createElement("table", __assign({}, rest, { ref: tableRef, style: __assign({ width: '100%', position: 'relative' }, style) }), children))));
};
/**
